...
public class PanelAccueil extends JPanel implements ActionListener
{
    ...
    public PanelAccueil(Controleur ctrl)
    {
        ...
        try { imgIconTitre = new ImageIcon(ImageIO.read(new File("./donnees/images/Titre_ADR.png")).getScaledInstance((this.lblTitre.getWidth()), this.lblTitre.getHeight(), Image.SCALE_SMOOTH)); } catch (IOException e) {}
